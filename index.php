//𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳
//• لا تنسى ذكر حقوق المطور عمر
//• المطور ↦ #OMER ABO AKER ↤
//• قناة المطور ↦ @Omegpt ↤
//𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳
<?php
ob_start();
error_reporting(0);
define("API_KEY", '7636134786:AAGtiL3maCPTBSrVlU8qgKxMMck2Q_GKjgw');
...
'inline_keyboard' => [
[['text' => "• مطور البوت •", 'url' => "https://t.me/omegpt"],
['text' => "• قناة البوت •", 'url' => "https://t.me/omegpt"]]
]
])
]);
return;
...
if (strpos($text, '/image ') === 0) {
    ...
    $waitingMessage = bot('sendMessage', [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [['text' => "• مطور البوت •", 'url' => "https://t.me/omegpt"],['text' => "• قناة البوت •", 'url' => "https://t.me/omegpt"]]
            ]
        ])
    ]);
